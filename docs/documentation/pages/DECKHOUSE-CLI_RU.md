...
| [`d8 cr`](../d8/reference/#d8-cr) | Команды для работы с хранилищем образов контейнеров.                                                                         |
...
| [`d8 iam`](../d8/reference/#d8-iam) | Команды для управления пользователями Deckhouse, группами и правами доступа.                                                                                                                  |
